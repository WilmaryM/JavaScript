...
class Cliente extends Persona{
    ...
    constructor( nombre, apellido, eada, fechaRegistro){
        super(nombre, apellido, eada)
...
let persona2 =new Persona('Jose', 'Matias', 50);
console.log( persona2.toString());

let empleado1 = new Empleado('Pablo', 'Marcos', '35', 3000);
console.log( empleado1.toString());
let empleado2 = new Empleado('Manuela', 'Amparo', 33, 6000);
